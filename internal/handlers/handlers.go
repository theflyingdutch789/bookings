...
// PostReservation handles the post request from reservation
...
// ReservationSummary renders the summary of submitting of data from reservation
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	reservation, ok := m.App.Session.Get(r.Context(), "reservation").(models.Reservation)
	if !ok {
		log.Println("Error getting data from session")
